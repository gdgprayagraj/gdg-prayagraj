      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {CoreTeam.map((member, index) => (
            <div key={index} className="bg-white dark:bg-[#111827] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex flex-col items-center">
                <div className="w-48 h-48 mb-4 relative rounded-lg overflow-hidden">
                  <Image
                    src={member.imageUrl}
                    alt={member.name}
                    fill
                ...
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-1 dark:text-gray-100">{member.name}</h3>
