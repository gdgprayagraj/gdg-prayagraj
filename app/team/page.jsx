      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {CoreTeam.map((member, index) => (
            <div
              key={index}
              className="bg-white dark:bg-[#111827]/80 dark:backdrop-blur-sm rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 dark:shadow-[#4285F4]/5 dark:hover:shadow-[#4285F4]/10"
            >
